...
// identity, contacts, trust, messaging, lifecycle, settings, views, bench,
// with records/payload/format as data helpers. Import sites and tests reach
// the public surface through this stable path.
